      ...
      <template v-slot:body>
        <div class="edit-wrap">
          <div class="item">
            ...
            <input type="tel" class="input" placeholder="手机号" v-model="checkedItem.receiverMobile" />
          </div>
          <div class="item">
            ...
            <select name="district" v-model="checkedItem.receiverDistrict">
              <option value="北京">长宁区</option>
              <option value="上海">虹口区</option>
              <option value="南通">南市区</option>
              <option value="上海">江宁区</option>
              <option value="南通">上饶区</option>
            </select>
          </div>
          <div class="item">
          ...
          <div class="item">
            <input type="text" placeholder="邮政编码" class="input" v-model="checkedItem.receiverZip" />
          </div>
        </div>
      </template>
    </modal>
  ...
  methods: {
    ...
    getCartList() {
      this.axios.get("/carts").then(res => {
        ...
        this.cartList.filter(item => (this.cartTotalQuantity += item.quantity));
      });
    },
    //打开新增地址弹框
    openAddressModal() {
    ...
    submitAddress() {
      ...
      if (userAction == 0 || userAction == 1) {
        ...
        if (!receiverName) {
          ...
          errMsg = "请输入详细收货地址";
        } else if (!receiverZip || !/^[0-9]{6}$/.test(receiverZip)) {
          errMsg = "请输入正确的邮政编码";
        }
        if (errMsg) {
